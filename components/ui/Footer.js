...
export default function Footer({ lastUpdated = '13 Aug 2026' }) {
    return (
        <footer style={{
            ...
            <p style={{ maxWidth: '900px', margin: '0 auto 10px auto', fontSize: '11.5px', color: 'var(--text-muted)' }}>
                <strong>* Data Exclusion Note:</strong> District 3291 is excluded from all statistics in this dashboard because its Rotaract is suspended. Consequently, its data is also omitted from associated Rotary and Interact metrics.
            </p>
