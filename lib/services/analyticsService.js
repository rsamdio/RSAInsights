...
export async function getLeaderboards({
    ...
    .map((d, idx) => {
        ...
        return {
            rank: idx + 1,
            worldwideRank: globalRankMap.get(String(d.District)) || (idx + 1),
            southAsiaRank: isSA ? (isWorldwide ? undefined : idx + 1) : null,
...
export async function getWorldwideStats({
    ...
    if (type === 'district') {
        ...
        const formatted = districts.map((d, idx) => {
            ...
            return {
                rank: idx + 1,
                worldwideRank: worldwideRankMap.get(String(d.District)) || (idx + 1),
