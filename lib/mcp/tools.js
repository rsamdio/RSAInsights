...
export const TOOLS_DEFINITIONS = [
    ...
    },
    {
        ...
        description: 'Retrieve top rankings and leaderboards for clubs and districts across South Asia. Answers questions about the largest clubs (by membership), top TRF donors, highest arrears dues, at-risk clubs (dues >= $75 USD), top districts (by clubs, members, TRF, arrears, or member growth), and new charters. Supports optional scoping to a district, zone, or country.',
        annotations: READ_ONLY_ANNOTATIONS,
        inputSchema: {
            type: 'object',
            properties: {
                category: {
                    ...
                    description: 'Leaderboard category to retrieve. Use "largest_clubs" for biggest clubs, "districts_by_member_growth" for fastest growing districts by membership, "at_risk_clubs" for clubs facing termination (dues >= $75 USD), or "trf_giving" for top foundation donors. Default is "all".'
                },
                district: {
                    type: 'string',
    ...
    },
    {
        ...
        description: 'Retrieve worldwide Rotaract and Interact statistics, global country growth rankings, and worldwide district leaderboards. Use type="district" with sortBy="member_growth_pct" (default) or "members", "clubs", "club_growth_pct" to discover top-performing districts globally (e.g. District 3261).',
        annotations: READ_ONLY_ANNOTATIONS,
        inputSchema: {
            type: 'object',
            properties: {
                ...
                zone: {
                    type: 'string',
                    description: 'Filter by Rotary Zone (e.g. "6", "4", "19")'
                },
                sortBy: {
                    type: 'string',
