...
export function getClubDetails(clubId) {
    ...
    const club = allClubs.find(c => (c['Club ID'] || c.id || '').toString() === clubId.toString());
    if (club) {
        return {
            ...
            sponsorClubs: club['Sponsor Clubs'] || club.sponsorClubs || 'None Reported',
